...
def chat_completion(openai_client: OpenAI, messages: List[Dict[str, str]], mcp_handle_client: MCPHandle, user_id: str, servers: List[McpServerName]) -> None:
    """
...
def main():    
    ...
    while True:
        ...
        if user_input:
            ...
            chat_completion(openai_client, messages, mcp_handle_client, user_id, servers)
