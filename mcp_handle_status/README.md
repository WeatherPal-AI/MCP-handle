...
**MCP Handle Status** - A centralized proxy for Model Context Protocol (MCP) services

*✨ Manage, monitor, and configure your MCP services from a single interface ✨*

<br />

<em>Derived from an open-source dashboard by JustSong (MIT).</em>
...
#### SQLite (Default)
No additional configuration required. Database file is created at `./data/mcp-handle-status.db`.
...
- **Documentation**: [Wiki](https://github.com/WeatherPal-AI/MCP-handle/tree/main/mcp_handle_status/wiki)
- **Issues**: [GitHub Issues](https://github.com/WeatherPal-AI/MCP-handle/tree/main/mcp_handle_status/issues)
...
**[⭐ Star this project](https://github.com/WeatherPal-AI/MCP-handle/tree/main/mcp_handle_status)** if you find it helpful!

Made with ❤️ by the MCP Handle Status team
