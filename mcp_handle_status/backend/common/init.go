...
func PrintHelp() {
	fmt.Println("Copyright (C) 2025 WeatherPal-AI. All rights reserved.")
	fmt.Println("GitHub: https://github.com/WeatherPal-AI/MCP-handle")
	fmt.Println("Usage: mcp-handle-status [--port <port>] [--log-dir <log directory>] [--version] [--help]")
}
