...
<Steps>
  ...
  <Step title="Enable Developer Mode">
    To connect MCP Handle MCP Server with Connectors, you need to ensure **Developer Mode** is enabled.
  ...
  <Step title="Add MCP Connector">
    ...
    <Note>
      MCP Handle AI authenticates your Strata server while generating server url.
    </Note>
