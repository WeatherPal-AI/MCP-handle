...
<Steps>
  ...
  <Step title="Configure Cursor IDE with Strata">
    ...
    <Tabs>
      <Tab title="Via Dashboard">
        ...
        From MCP Handle Dashboard, click **Add to Cursor** and you will be redirected to Cursor.
  ...
  <Step title="Verify Tools Loading">
    ...
    In Cursor Settings, navigate to **Tools & MCP**. You will see **mcp_handle-strata** listed under **Installed MCP Servers**.
    ...
    Tap on **mcp_handle-strata** to view the list of tools loaded from Strata server.
