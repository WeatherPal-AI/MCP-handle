...
<Steps>
  ...
  <Step title="Configure Claude Code">
    ...
    ```bash
    claude mcp add mcp_handle-strata npx mcp-remote <strata-url>
     ```
    <img
  ...
  <Step title="Other Commands related to MCPs">
    - Remove MCP Server: `claude mcp remove mcp_handle-strata`
    - List all MCP Servers: `claude mcp list`
    - Details of Strata: `claude mcp get mcp_handle-strata`
  </Step>
