...
<Steps>
  ...
  <Step title="Configure VS Code IDE with Strata">
    ...
    <Tabs>
      <Tab title="Via Dashboard">
        ...
        From MCP Handle Dashboard, click **Add to VS Code** and you will be redirected to VS Code IDE.
  ...
  <Step title="Verify Tools Loading">
    In Github Copilot Chat, open **"Configure Tools"** (Tools icon) and scroll down to **MCP Server: mcp_handle-strata**. You will see the list of available tools in Strata.
    <img
