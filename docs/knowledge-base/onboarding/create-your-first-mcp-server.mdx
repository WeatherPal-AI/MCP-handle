...
<Steps>
  <Step title="Create from MCP Handle Dashboard">
    Navigate to the [MCP Handle Dashboard](https://www.mcp-handle.dev/home) and click **"MCP Server"** in the left sidebar.
  ...
  <Step title="Complete OAuth Authentication">
    ...
    <Accordion title="🔐 Gmail OAuth Flow">
      ...
      - Grant Gmail permissions to MCP Handle
