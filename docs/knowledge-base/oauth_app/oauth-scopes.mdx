...
This page provides a comprehensive reference of OAuth scopes required for each supported app in MCP Handle AI.

<Note>
These are the minimum OAuth scopes required for all tools in each MCP Handle MCP server to function properly.
</Note>
