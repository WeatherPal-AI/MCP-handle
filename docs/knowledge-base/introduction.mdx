...
<CardGroup cols={1}>
  <Card title="How to use MCP Server in ChatGPT" href="use-mcp-server/chatgpt">
    Learn how to integrate MCP Handle MCP Servers with ChatGPT for enhanced AI workflow experience.
  </Card>
  <Card title="How to use MCP Server in Claude Code" href="use-mcp-server/claude_code">
    Learn how to integrate MCP Handle MCP Servers with Claude Code for enhanced AI workflow experience.
  </Card>
  <Card title="How to use MCP Server in Claude Desktop" href="use-mcp-server/claude_desktop">
    Learn how to integrate MCP Handle MCP Servers with Claude Desktop for enhanced AI workflow experience.
  </Card>
  <Card title="How to use MCP Server in Cline" href="use-mcp-server/cline">
    Learn how to integrate MCP Handle MCP Servers with Cline for enhanced AI workflow experience.
  </Card>
  <Card title="How to use MCP Server in Continue" href="use-mcp-server/continue">
    Learn how to integrate MCP Handle MCP Servers with Continue for enhanced AI workflow experience.
  </Card>
  <Card title="How to use MCP Server in Cursor IDE" href="use-mcp-server/cursor">
    Learn how to integrate MCP Handle MCP Servers with Cursor IDE for enhanced AI coding experience.
  </Card>
  <Card title="How to use MCP Server in Gemini CLI" href="use-mcp-server/gemini_cli">
    Learn how to integrate MCP Handle MCP Servers with Gemini CLI for enhanced AI coding experience.
  </Card>
  <Card title="How to use MCP Server in Kiro IDE" href="use-mcp-server/kiro">
    Learn how to integrate MCP Handle MCP Servers with Kiro for enhanced AI workflow experience.
  </Card>
  <Card title="How to use MCP Server in n8n" href="use-mcp-server/n8n">
    Learn how to integrate MCP Handle MCP Servers with n8n for enhanced AI coding experience.
  </Card>
  <Card title="How to use MCP Server in VS Code IDE" href="use-mcp-server/vs_code">
    Learn how to integrate MCP Handle MCP Servers with VS Code IDE for enhanced AI coding experience.
  </Card>
  <Card title="How to use MCP Server in Windsurf IDE" href="use-mcp-server/windsurf">
    Learn how to integrate MCP Handle MCP Servers with Windsurf IDE for enhanced AI coding experience.
  </Card>
</CardGroup>
