...
**Prerequisites** Before you begin, [create an account](https://www.mcp-handle.dev/home/api-keys) and get the API Key.

</Info>

## Strata
MCP Handle Strata server that lets AI agents handle any tools progressively.

<Tabs>
  <Tab title="UI">
    <Steps>
      <Step title="Open Dashboard">
        Go to your <a href="https://www.mcp-handle.dev/home/mcp-servers">Dashboard</a>.
        
        <Tip>
        MCP Handle enables all integrations for you by default. Click the ellipsis button if you want to disable a specific integration.
        </Tip>
    ...
    <Steps>
      ...
      <Step title="Create Strata MCP Server">
        <CodeGroup>
          ...
          const mcp_handle = new MCP Handle.Client({ apiKey: 'YOUR_MCP_HANDLE_API_KEY' });
          const strata = await mcp_handle.strata.create({
            userId: 'user123',
            servers: ['GMAIL', 'YOUTUBE'],
          });
          ```
  ...
  <Tab title="Open Source">
    <Tip>
    Visit https://github.com/MCP Handle-AI/mcp_handle to view the source code and find more information
    </Tip>
    <Steps>
