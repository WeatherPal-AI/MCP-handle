# Contributing to MCP Handle AI

Thank you for your interest in contributing to MCP Handle AI! This document outlines the process and conventions we use for contributions, pull requests, and commit messages.
...
[Contributor License Agreement](https://cla-assistant.io/MCP Handle-AI/mcp_handle)
...
2. Clone your fork: `git clone https://github.com/yourusername/mcp_handleAi.git`
3. Add the upstream remote: `git remote add upstream https://github.com/MCP Handle-AI/mcp_handle.git`
...
By contributing to MCP Handle AI, you agree that your contributions will be licensed under the project's [Apache 2.0 license](LICENSE).