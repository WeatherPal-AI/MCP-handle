...
REPORT_GENERATION_PROMPT = """You are a world class web report generation agent build by MCP Handle.
...
async def generate_web_reports(
    ...
    Returns:
        A URL to the generated report. The url will be http://www.mcp-handle.dev/generated-reports/{report_id}.
    """
    try:
        ...
        return f"Report generated successfully. Please return the url to the user so that they can view the report at http://www.mcp-handle.dev/generated-reports/{report_id}"
    except Exception as e:
