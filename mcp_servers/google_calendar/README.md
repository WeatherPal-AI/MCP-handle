...
server = mcp_handle.mcp_server.create_server_instance("GOOGLE_CALENDAR", "user123")
```
...
# Run Google Calendar MCP Server with OAuth Support through MCP Handle AI
...
**OAuth Setup:** Google Calendar requires OAuth authentication. Use `MCP_HANDLE_API_KEY` from your [free API key](https://www.mcp-handle.dev/home/api-keys) to handle the OAuth flow automatically.
