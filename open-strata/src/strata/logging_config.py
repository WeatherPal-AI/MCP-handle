...
def log_banner() -> None:
    """Log the MCP Handle colorful banner using a temporary handler."""
  ...
  \033[1;36m═════════════════════════════════════════════════════════════════════════════\033[0m
  \033[1;32m STRATA MCP  \033[0m·\033[1;33m  MCP Handle orchestration that uses tools reliably at any scale \033[0m
  \033[1;36m═════════════════════════════════════════════════════════════════════════════\033[0m
